...
?>
  <div class="card pad reveal" style="max-width:560px;margin:0 auto">
    ...
    <form method="post" class="stack" style="margin-top:1rem">
      <div>
        <label>Email</label>
        <input name="email" type="email" placeholder="admin@ardhiguide.local" required autocomplete="email">
      </div>
      <div>
    ...
    <div class="forgot-note">
      ...
      <p>Until self-service password reset is enabled, please contact our admin team. Send your registered email and we will reset it for you.</p>
      <div class="contact-buttons" style="justify-content:flex-start">
        <a class="contact-btn wa" href="https://wa.me/255657925368?text=Hello%20Ardhi%20Guide%2C%20I%20forgot%20my%20password.%20My%20email%3A%20" target="_blank" rel="noopener">
