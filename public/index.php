...
?>
  ...
  <section class="cta-banner reveal">
    <div>
      ...
      <p>Create a free account, submit your land with photos and optional documents, and our team will review it before publishing. Pay your listing fee online (mobile money or card) — full steps in our payment guide.</p>
    </div>
    <div class="btns">
      <?php if ($canList): ?>
        <a class="btn" href="<?= APP_BASE_URL ?>/submit-listing.php">Submit a listing</a>
