  ...
  <div class="card pad reveal" style="max-width:920px;margin:0 auto">
    ...
    <form method="post" enctype="multipart/form-data" class="stack" style="margin-top:1rem">
      ...
      <div>
        ...
        <div class="sub" style="font-size:.92rem;margin-top:.35rem">Fee is due before we prioritise review. Follow the published payment guide for M-Pesa steps; admin will confirm receipt.</div>
      </div>
